...
const CardUnidad = ({ unidad, onDelete, recargar }) => {
  ...
  const onSubmit = (data) => {
    ...
    return (
      <Card elevation={10} style={{ width: '20rem', height: 'auto' }} className="card-unidad">
        <CardMedia sx={{ height: 160 }} image={"https://autoselrentacar.com/themes/default/images/t4.png"} title="Unidad" />
        {!edit && (
          <>
            ...
            <Typography className='card-unidad-num' variant="h5" component="div">
